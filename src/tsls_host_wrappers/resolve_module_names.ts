...
export default function resolveModuleNamesWrapper(tsLsHost: LanguageServiceHost, logger: Logger, config: any, typescript: typeof ts_module, projectDirectory: string) {
