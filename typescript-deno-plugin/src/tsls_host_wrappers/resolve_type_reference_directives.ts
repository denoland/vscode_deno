...
export default function resolveTypeReferenceDirectivesWrapper(
  tsLsHost: LanguageServiceHost,
  config: any,
  logger: Logger,
) {
  const originalResolveTypeReferenceDirectives =
  ...
  const resolveTypeReferenceDirectives:
    typeof tsLsHost.resolveTypeReferenceDirectives = (
