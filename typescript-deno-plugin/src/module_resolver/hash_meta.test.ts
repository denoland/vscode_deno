...
test("hash_meta with javascript file", () => {
  const cacheFilepath = path.join(
    denoDir,
    "deps",
    "https",
...
test("hash_meta without extension name", () => {
  const cacheFilepath = path.join(
    denoDir,
    "deps",
    "https",
...
test("hash_meta if have content-type", () => {
  const cacheFilepath = path.join(
    denoDir,
    "deps",
    "https",
...
test("hash_meta if have content-type typescript", () => {
  const cacheFilepath = path.join(
    denoDir,
    "deps",
    "https",
...
test("hash_meta: if meta file missing url", () => {
  const notExistCache = path.join(
    denoDir,
    "deps",
    "https",
